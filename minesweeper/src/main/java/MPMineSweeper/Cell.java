...
public class Cell {
     ...
     * with zero neighboring mines, not revealed, and with no player who revealed it.
     */
    public Cell() {
        this.isMine = false;
        this.flagged = false;
     ...
     * @return the player who revealed the cell, or null if the cell hasn't been revealed yet.
     */
